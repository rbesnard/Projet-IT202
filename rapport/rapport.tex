...
thread quand celui-ci est dans la liste "zombie". Mais quand ce thread est dans la liste "ready", elle peut contenir la valeur de retour du thread qu'il attend éventuellement.
